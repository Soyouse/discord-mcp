 ...
 *
 * ⚠️ DIFFÉRENCE CLÉ vs prospection-mcp : AUCUN HANDLER_MAP manuel.
 * prospection oblige "l'étape 3" (mapper à la main dans dispatch) → footgun, oubliable.
 * Ici : déposer un fichier dans handlers/ qui exporte `tool = {name, description, inputSchema, handle}`
 * suffit. Impossible d'oublier. Convention > configuration.
 */
